...
var App = function() {
    var app =function () {
        ...
        /*文字部分END*/
        fullMarkdown= ["我叫张冠\n====\n\n坐标：湖北武汉。\n目前：23岁\n做的WEB前端。 对就是我 \n\n 我毕业于湖北交通技术学院 16届毕业生 专业是：土木工程 \n\n 在校期间考过了长沙理工的专升本考试 成功考入长沙理工\n 2016年下旬，了解到了web行业，对此产生了浓厚的兴趣\n 自学一段时间后 面试进入了武汉阿托普软件有限公司 后来在atop公司工作了一年半  \n 搭建了四五个网站的框架 \n 还是很开心的 \n 这是我的git:https://github.com/zg95/ 上面有几个我自己写的小项目  \n 这个程序是用jq写的 \n  写的不好大家见谅 \n 灵感来自:http://strml.net/。\n\n\n\n\n\n"];
